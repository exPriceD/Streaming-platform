...
type ChatServiceClient interface {
	...
	StreamMessages(ctx context.Context, in *StreamMessageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error)
}
...
func (c *chatServiceClient) StreamMessages(ctx context.Context, in *StreamMessageRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ChatService_ServiceDesc.Streams[0], ChatService_StreamMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamMessageRequest, ChatMessage]{ClientStream: stream}
...
type ChatServiceServer interface {
	...
	// Стриминг новых сообщений
	StreamMessages(*StreamMessageRequest, grpc.ServerStreamingServer[ChatMessage]) error
...
func (UnimplementedChatServiceServer) StreamMessages(*StreamMessageRequest, grpc.ServerStreamingServer[ChatMessage]) error {
...
func _ChatService_StreamMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChatServiceServer).StreamMessages(m, &grpc.GenericServerStream[StreamMessageRequest, ChatMessage]{ServerStream: stream})
}
